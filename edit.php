...
<div class="bg-white shadow-md rounded-lg p-8 max-w-2xl mx-auto">
    ...
    <h2 class="text-3xl font-bold text-gray-800 mb-6">Edit Kontak</h2>

    <form method="POST" class="space-y-5">
        <div>
            <label for="nama" class="block text-sm font-medium text-gray-700">Nama:</label>
            <input type="text" name="nama" id="nama" required value="<?= htmlspecialchars($kontak['nama']) ?>"
        ...
        <div>
            ...
            <input type="text" name="telepon" id="telepon" required value="<?= htmlspecialchars($kontak['telepon']) ?>"
                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm 
                          focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        </div>
        ...
        <div>
            ...
            <input type="email" name="email" id="email" required value="<?= htmlspecialchars($kontak['email']) ?>"
                   class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm 
                          focus:outline-none focus:ring-blue-500 focus:border-blue-500">
        </div>
